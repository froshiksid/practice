...
name = 'Анастасия'
hello = my_module.hello_world(name)
print(hello)  # Вызовите функцию hello_world из модуля my_module
...
print(hello)  # Функция hello_world должна вызываться без указания модуля
